In questo progetto sono contenuti i file utilizzati per svolgere il progetto di Deep Learning. Non sono state caricate le immagini del dataset in quanto pesano troppo.
